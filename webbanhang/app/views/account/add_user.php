...
<div class="container mt-5 animate-fade-in">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body p-4">
            ...
            <?php endif; ?>
            <form method="POST" action="/account/saveUser" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-plus-circle"></i> Thêm người dùng</button>
